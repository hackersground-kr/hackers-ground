...
3. **라벨 부여**:
    - **완료(COMPLETED)**: 모든 요구사항이 충족되고, 이슈 내용이 정확한 경우, 'verified' 라벨을 부여하며, 참가자는 사전워크샵 참가 자격을 부여합니다.
    - **미완료(NOT_COMPLETED)**: 요구된 챌린지를 모두 완료하지 않은 경우, 'incomplete' 라벨을 부여하며, 수정을 요청받게 됩니다.
